...
class TestEricScraperFunctions(unittest.TestCase):
    """Additional comprehensive tests for centennial scraper functions."""
    ...
    @patch('centennial_scraper.fetch_html', return_value=SAMPLE_HTML)
